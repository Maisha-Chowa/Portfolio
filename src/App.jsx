...
const projects = [
  {
    ...
    description:
      "Modular framework for UI/API automation with CI integration and reporting.",
    links: [{ label: "View Code", href: "#" }],
  },
  {
    title: "AI Audio Platform QA",
    description:
      "Full test strategy for an AI-powered audio editor including load and API testing.",
    links: [{ label: "Case Study", href: "#" }],
  },
  {
    title: "API Monitoring Suite",
    description:
      "API regression suite with Postman collections and environment-driven checks.",
    links: [{ label: "View Tool", href: "#" }],
  },
  {
    title: "Performance Benchmarking",
    description:
      "Locust-based load tests to define concurrency thresholds and bottlenecks.",
